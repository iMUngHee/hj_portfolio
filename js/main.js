window.addEventListener('DOMContentLoaded', function () {
  ...
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft2 > div:nth-child(9)',
    { y: -600, duration: 10 },
  );
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft2 > div:nth-child(8)',
    { y: -600, duration: 10 },
  );
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft2 > div:nth-child(7)',
    { y: -600, duration: 10 },
  );
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft2 > div:nth-child(6)',
    { y: -600, duration: 10 },
  );
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft2 > div:nth-child(5)',
    { y: -600, duration: 10 },
  );
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft2 > div:nth-child(4)',
    { y: -600, duration: 10 },
  );
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft2 > div:nth-child(3)',
    { y: -600, duration: 10 },
  );
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft2 > div:nth-child(2)',
    { y: -600, duration: 10 },
  );
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft2 > div:nth-child(1)',
    { y: -600, duration: 10 },
  );

  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft1 > div:nth-child(7)',
    { y: -700, duration: 10 },
  );
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft1 > div:nth-child(6)',
    { y: -700, duration: 10 },
  );
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft1 > div:nth-child(5)',
    { y: -700, duration: 10 },
  );
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft1 > div:nth-child(4)',
    { y: -700, duration: 10 },
  );
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft1 > div:nth-child(3)',
    { y: -700, duration: 10 },
  );
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft1 > div:nth-child(2)',
    { y: -700, duration: 10 },
  );
  sc05.to(
    '#section05 .fix-this-05 .se05_cnt01 .minecraft1 > div:nth-child(1)',
    { y: -700, duration: 10 },
  );
  ...
  gsap.to('#section05 .fix-this-05 .se05_cnt02 .left .rotate_img > img', {
    //첫번쨰 이미지 돌아가는 구동
    rotate: 270,
    scrollTrigger: {
      trigger: '#section05',
  ...
  gsap.to('#section05 .fix-this-05 .se05_cnt02 .right .inner', {
    //오른쪽 이미지 들어오는 구동
    x: -372,
    scrollTrigger: {
      trigger: '#section05',
  ...
  gsap.to('#section05 .fix-this-05 .se05_cnt03 .invert02', {
    // 텍스트 반전 구동
    clipPath: 'inset(0% 0% 0% 0%)',
    scrollTrigger: {
      trigger: '#section05',
  ...
  $('#section08 .fix-this-08 .se08_cnt01 .inner .right_slide')
    .slick({
